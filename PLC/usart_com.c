...
void EPC_FORCE_ON(void)
{
    ...
    case 0x0E24:
        prog_address = 0X01C4, p_all_data[prog_address] = 0x09;
        break;

    case 0x0E25:
        prog_address = 0X01C4, p_all_data[prog_address] = 0x0A;
        break;
...
void Process_switch(void)
{
    ...
    {
    case 0x30:
        data_size = tx_data[4], PC_READ_byte();
        break;// 读数据

    case 0x31:
        data_size = tx_data[4], PC_WRITE_byte();
        break;// 写数据

    case 0x34:
        find_end();
        break;// 查找指令，如查找到有数据则返回6

    case 0x37:
        setup_HL(), PC_FORCE_ON();
        break;// PLC   启动 远程 “0x37”

    case 0x38:
        setup_HL(), PC_FORCE_OFF();
        break;// PLC 停止 远程 “0x38”
